...
export default {
  ...
  donateTime: {
    ...
    modeSeconds: 'Seconds per R$ 1',
    modeMinute: 'Value per minute',
    donateValueLabel: 'Donation value',
    donateValueHint: 'Enter the value in Brazilian reais (R$)',
    secondsPerRealLabel: 'Seconds per R$ 1.00',
    secondsPerRealHint: 'How many seconds equal R$ 1.00',
    secondsSuffix: 's / R$',
    valuePerMinuteLabel: 'Value of 1 minute',
    valuePerMinuteHint: 'How much does 1 live minute cost (in R$)',
