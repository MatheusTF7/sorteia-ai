...
export default {
  ...
  bingo: {
    ...
    sharedHostTitle: 'Create a shared room',
    sharedHostDesc:
      'Enter a JSONBin key to create the room and share the same bingo match with other phones.',
    sharedApiKeyLabel: 'JSONBin key',
    sharedApiKeyHint: 'Use an Access Key or Master Key with permission to create and update bins.',
    sharedGuestTitle: 'Join a room',
    sharedGuestDesc: 'Paste the code or link sent by the drawer to follow the same match.',
    sharedPlayerNameLabel: 'Your name',
    sharedPlayerNameRequired: 'Enter your name before sending the card to the drawer.',
    sharedRoomInputLabel: 'Room code or link',
    sharedRoomInputHint: 'Example: 67f... or http://localhost:9000/sorteia-ai/#/bingo?room=...',
    sharedSelectRoleFirst: 'Choose a role above to configure the shared room.',
    sharedRoomBadge: 'Shared room',
    copyRoomCode: 'Copy code',
    copyRoomLink: 'Copy link',
    sharedClaimsRefresh: 'Refresh bingo claims',
    sharedClaimsTitle: 'Bingo claims',
    sharedClaimsEmpty: 'No participant has asked for verification yet.',
    sharedClaimSubmittedAt: 'Sent at {time}',
    sharedClaimCardCount: '{count} marked numbers submitted',
    sharedClaimReviewAction: 'Review card',
    syncNow: 'Sync now',
    sharedFeedTitle: 'Synced drawing',
    sharedWaitingNumber: 'Waiting for the drawer to call the first number',
    sharedStatusConnected: 'Synced at {time}',
    sharedStatusWatching: 'Light sync active. Last room update received at {time}',
    sharedStatusOnDemand: 'The room will only be checked when you ask to validate the bingo.',
    sharedStatusReady: 'Room connected and ready to share',
    sharedStatusError: 'Could not sync the room right now.',
    sharedGenericError: 'Could not sync the shared room.',
    sharedRoomCreated: 'Shared room created successfully.',
    sharedRoomJoined: 'You joined the shared room.',
    sharedRoomCodeCopied: 'Room code copied.',
    sharedRoomLinkCopied: 'Room link copied.',
    sharedCopyError: 'Could not copy the room information.',
    sharedQrTitle: 'Join with QR Code',
    sharedQrDesc: 'Participants can point the camera to enter the same room instantly.',
    sharedQrCodeHint: 'The same match is still available through the code and the link.',
    sharedQrAlt: 'QR code for the shared bingo room',
    sharedClaimAction: 'I got bingo',
    sharedClaimHint: 'When you complete the card, tap here to send it to the drawer for review.',
    sharedClaimMarkRequired: 'Mark at least one number before sending the request to the drawer.',
    sharedClaimSent: 'Your request was sent to the drawer with your name and marked numbers.',
    ...
    validateResultIncomplete: 'Incomplete card!',
    validateResultInvalid: 'Invalid card!',
    validateMissingCountLabel: '{count} numbers are missing to complete the 24 marked ones.',
