...
export default {
  ...
  bingo: {
    ...
    sessionModeTitle: 'Modo da partida',
    playLocal: 'Local',
    playShared: 'Compartilhado',
    ...
    sharedHostTitle: 'Criar sala compartilhada',
    sharedHostDesc:
      'Informe uma chave do JSONBin para criar a sala e compartilhar o jogo com outros celulares.',
    sharedApiKeyLabel: 'Chave do JSONBin',
    sharedApiKeyHint: 'Use uma Access Key ou Master Key com permissao para criar/atualizar bins.',
    sharedGuestTitle: 'Entrar em uma sala',
    sharedGuestDesc: 'Cole o codigo ou link enviado pelo sorteador para acompanhar o mesmo jogo.',
    sharedPlayerNameLabel: 'Seu nome',
    sharedPlayerNameRequired: 'Informe seu nome antes de enviar a cartela ao mestre.',
    sharedRoomInputLabel: 'Codigo ou link da sala',
    sharedRoomInputHint: 'Exemplo: 67f... ou http://localhost:9000/sorteia-ai/#/bingo?room=...',
    sharedSelectRoleFirst: 'Escolha um modo acima para configurar a sala compartilhada.',
    sharedRoomBadge: 'Sala compartilhada',
    copyRoomCode: 'Copiar codigo',
    copyRoomLink: 'Copiar link',
    sharedClaimsRefresh: 'Atualizar pedidos de bingo',
    sharedClaimsTitle: 'Pedidos de bingo',
    sharedClaimsEmpty: 'Nenhum participante pediu conferencia ainda.',
    sharedClaimSubmittedAt: 'Enviado as {time}',
    sharedClaimCardCount: '{count} numeros marcados enviados',
    sharedClaimReviewAction: 'Conferir cartela',
    syncNow: 'Atualizar agora',
    sharedFeedTitle: 'Sorteio sincronizado',
    sharedWaitingNumber: 'Aguardando o primeiro numero do sorteador',
    sharedStatusConnected: 'Sincronizado as {time}',
    sharedStatusWatching: 'Escuta leve ativa. Ultima atualizacao recebida as {time}',
    sharedStatusOnDemand:
      'A sala sera consultada apenas quando voce pedir a conferência do bingo.',
    sharedStatusReady: 'Sala conectada e pronta para compartilhar',
    sharedStatusError: 'Nao foi possivel sincronizar a sala agora.',
    sharedGenericError: 'Nao foi possivel sincronizar a sala compartilhada.',
    sharedRoomCreated: 'Sala compartilhada criada com sucesso.',
    sharedRoomJoined: 'Voce entrou na sala compartilhada.',
    sharedRoomCodeCopied: 'Codigo da sala copiado.',
    sharedRoomLinkCopied: 'Link da sala copiado.',
    sharedCopyError: 'Nao foi possivel copiar as informacoes da sala.',
    sharedQrTitle: 'Entrar com QR Code',
    sharedQrDesc: 'O participante pode apontar a camera para entrar direto na mesma sala.',
    sharedQrCodeHint: 'O mesmo jogo tambem continua disponivel pelo codigo e pelo link.',
    sharedQrAlt: 'QR Code da sala compartilhada do bingo',
    sharedClaimAction: 'Fiz bingo',
    sharedClaimHint:
      'Quando fechar a cartela, toque aqui para enviar sua cartela ao mestre conferir.',
    sharedClaimMarkRequired: 'Marque pelo menos um numero antes de enviar o pedido ao mestre.',
    sharedClaimSent: 'Seu pedido foi enviado ao mestre com seu nome e os numeros marcados.',
    ...
    validateResultIncomplete: 'Cartela incompleta!',
    validateResultInvalid: 'Cartela inválida!',
    validateMissingCountLabel: 'Faltam {count} números para completar os 24 marcados.',
